...
var DEFAULT_OPTIONS = {
  name: 1.0, id: 1.0, attributes: 1.0, contents: 1.0, contents_threshold: 0.99 // weight multipliers
};
...
function createHeuristic(weights) {
  ...
  function heuristic($n1, $n2, childChanges) {
    ...
    if (possibleChildChanges > 0) {
      ...
      var contentsDifferSignificantly = (totalChildChanges / possibleChildChanges) > weights.contents_threshold;
